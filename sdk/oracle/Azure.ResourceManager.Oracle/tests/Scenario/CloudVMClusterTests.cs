...
{
    [TestFixture]
    public class CloudVMClusterTests : OracleManagementTestBase
    {
        ...
        public CloudVMClusterTests() : base(true)
        {
        }
        [SetUp]
        ...
        {
            // Create
            _vmClusterName = Recording.GenerateAssetName("OFake_sdkVmCluster");
