...
namespace Azure.ResourceManager.Oracle.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DbSystemShapeListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DbSystemShapeListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DbSystemShapeListResult)} does not support '{format}' format.");
            }
        ...
        internal static DbSystemShapeListResult DeserializeDbSystemShapeListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<DbSystemShape> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<DbSystemShape> array = new List<DbSystemShape>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(DbSystemShape.DeserializeDbSystemShape(item));
                    }
                    value = array;
                    continue;
                }
            ...
            return new DbSystemShapeListResult(value, nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DbSystemShapeListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DbSystemShapeListResult)} does not support '{options.Format}' format.");
            }
        }
